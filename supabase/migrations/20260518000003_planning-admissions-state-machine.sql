...
begin
    ...
    if new_phase.project_phase_order = previous_phase.project_phase_order then
        ...
        if previous_state_name = 'En revisión' then
            ...
            if new_state_name not in ('Consignado a Planeamiento y Admisión', 'Aprobado por Coordinador', 'Rechazado para corrección') then
            ...
            if new_state_name not in ('Aprobado por Coordinador', 'En revisión') then
